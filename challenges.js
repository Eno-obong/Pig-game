...
// 1. A player looses his ENTIRE score when he rolls two 6 in a HTMLTableRowElement.
//  After that, it's the next player's turn.
// (Hint: Always save the previous dice roll in a separate variable).
// 2. Add an input field in the HTML where players can set the winning score,
//  so that they can change predefined score of 100.
...
document.querySelector(".btn-roll").addEventListener("click", function(){
    ...
    // // 3. Update the roundSore IF the rolled number WAS NOT a 1
    if(dice1 !== 1 && dice2 !== 1){
        // Add score
